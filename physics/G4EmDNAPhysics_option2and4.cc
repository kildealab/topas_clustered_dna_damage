...
// The following are needed in order to use EM Physics builders
// e+
...
//--------------------------------------------------------------------------------------------------
// Constructor that accepts a Topas parameter manager. This is the constructor that is typically
// called
//--------------------------------------------------------------------------------------------------
...
//--------------------------------------------------------------------------------------------------
// Additional constructor that is required for Physics Constructor Factory. Get a compilation error
...
//--------------------------------------------------------------------------------------------------
// Define the particle species to be handled by this physics module.
//--------------------------------------------------------------------------------------------------
...
//--------------------------------------------------------------------------------------------------
// Define the physics processes to be implemented by this physics module
//--------------------------------------------------------------------------------------------------
void G4EmDNAPhysics_option2and4::ConstructProcess()
{
    ...
    while( (*myParticleIterator)() )
    {
        ...
        //------------------------------------------------------------------------------------------
        // Handle electrons. Two alternative models are available for (i) elastic scatter, (ii)
        // excitation, and (iii) ionization. To combine multiple models, start by assigning a dummy
        // model here. The appropriate models will be assigned to specific energy regions later.
        //------------------------------------------------------------------------------------------
        if (particleName == "e-") {
            
            // Solvation
            G4DNAElectronSolvation* solvation = new G4DNAElectronSolvation("e-_G4DNAElectronSolvation");
            G4DNAOneStepThermalizationModel* therm = new G4DNAOneStepThermalizationModel();
        ...
        //==========================================================================================
        //------------------------------------------------------------------------------------------ 
        // Handle positrons. Identical to G4EmStandardPhysics_option3
        //------------------------------------------------------------------------------------------             
        ...
        //------------------------------------------------------------------------------------------             
            ...
            // Camma conversion - Livermore model below 80 GeV
    ...
    //----------------------------------------------------------------------------------------------
    // Now assign different physics models for electrons at different energies. Note that these are
    // applied to the entire simulation volume (i.e. the World volume).
    //----------------------------------------------------------------------------------------------
    G4EmConfigurator* em_config = G4LossTableManager::Instance()->EmConfigurator();
    G4VEmModel* mod;

    //----------------------------------------------------------------------------------------------
    // Elastic scattering. Use Champion model above 10 keV and Uehara model below 10 keV.
    //----------------------------------------------------------------------------------------------
    ...
    //----------------------------------------------------------------------------------------------
    // Excitation. Use Born model above 10 keV and Emfietzoglou model below 10 keV.
    //----------------------------------------------------------------------------------------------
    ...
    //----------------------------------------------------------------------------------------------
    // Ionization. Use Born model above 10 keV and Emfietzoglou model below 10 keV.
    //----------------------------------------------------------------------------------------------
